...
Launch the [Stella Atari 2600 emulator](https://stella-emu.github.io/) and navigate once again to the folder containing the project and select the .bin to begin playing.
